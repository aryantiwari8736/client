...
<section>
  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-8 md:px-10 md:py-8 lg:py-12">
          ...
          <div className="flex flex-col gap-4 rounded-md border border-solid bg-[#f2f2f7] p-6 md:p-4">
            ...
            <div className="flex items-center gap-2 sm:gap-x-4">
              <div className="flex items-center gap-x-2">
                <img src="https://assets.website-files.com/624380709031623bfe4aee60/6243807090316203124aee66_placeholder-image.svg" alt="" className="h-12 w-12 rounded-full" />
...
<section id="section">
  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-4 md:px-10 md:py-6 lg:py-12">
    ...
    <p className="mb-8 max-w-lg text-sm text-[#808080] sm:text-base lg:mb-24">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat.</p>
