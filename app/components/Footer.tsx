...
const Footer = (props: Props) => {
  return (
    <div className="bg-gray-200  dark:bg-gray-900">
      <hr />
    <div className="px-4  pt-16 dark:text-white mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          >
            <Image width={50} height={50} alt="springbeelogo" src="/assests/springbeeIcon.png" />
            <span className="ml-2 dark:text-white text-xl font-bold tracking-wide text-gray-800 uppercase">
               SpringBee
            </span>
          </a>
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            <p className="mr-1 dark:text-white  text-gray-800">Phone:</p>
            <a
              href="tel:+918299550885"
          ...
          <div className="flex">
            <p className="mr-1 dark:text-white  text-gray-800">Email:</p>
            <a
              ...
              className="transition-colors dark:text-white  duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
            >
              springbeelive@gmail.com
            </a>
          </div>
          <div className="flex">
            <p className="mr-1 dark:text-white  text-gray-800">Address:</p>
            <a
        ...
        <div>
          <span className="text-base  dark:text-white font-bold tracking-wide text-gray-900">
            Social
          </span>
      ...
      <div className="flex flex-col-reverse  dark:text-white justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm dark:text-white  text-gray-600">
          © Copyright 2024SpringBee Inc. All rights reserved.
        </p>
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          <li>
            <a
              href="/"
              className="text-sm dark:text-white  text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400"
            >
              F.A.Q
            </a>
          </li>
