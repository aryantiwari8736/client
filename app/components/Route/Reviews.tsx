...
export const reviews = [
  ...
  },
  {
    ...
    comment:
      "SpringBee has been a breath of fresh air for my design projects. Their deep understanding of web aesthetics and user experience has elevated my work to new heights. With their guidance, I've been able to create visually stunning and user-friendly websites that captivate audiences. SpringBee's collaborative approach and attention to detail make them an indispensable partner in my design journey",
  },
];
