...
const NewsLetterProduct = (props: Props) => {
  return (
    <section className="flex flex-col mb-10 max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 md:flex-row md:h-48">
    <div className="md:flex md:items-center md:justify-center md:w-1/2 md:bg-gray-700 md:dark:bg-gray-800">
        <div className="px-6 py-3 md:px-8 md:py-0">
            <h2 className="text-lg font-bold text-gray-700 dark:text-white md:text-gray-100">Subscribe For <span className="text-blue-600 dark:text-blue-400 md:text-blue-300">Project</span> Updates</h2>

            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 md:text-gray-400">We{`'`}ll send you updates whenever we release any new digital or make any new update in our existing products.</p>
        </div>
    </div>
