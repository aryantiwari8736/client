  ...
  <div className="mx-auto max-w-7xl px-5 py-2 md:px-10 md:py-2 lg:py-4">
    ...
    <div className="mx-auto w-full max-w-3xl">
      ...
      <div className="text-center">
        ...
        <h2 className="text-3xl font-semibold capitalize md:text-5xl">How SpringBee<span className="bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/639156ce1c70c97aeb755c8a_Rectangle%2010%20(1).svg')] bg-cover bg-center bg-no-repeat px-4 text-white">helps</span>
        </h2>
    ...
    <div className="mx-auto grid grid-cols-1 gap-4 sm:justify-items-stretch md:grid-cols-3 lg:gap-8">
      ...
      <div className="relative flex flex-col items-center gap-4 p-8 text-center">
        ...
        <p className="mb-2 text-xl font-semibold">Learn</p>
        <p className="text-sm text-[#636262]">Lorem ipsum dolor sit amet consectetur adipiscing elit ut aliquam, purus sit.</p>
        <img src="https://assets.website-files.com/63904f663019b0d8edf8d57c/639833af1925275b6f0b43e1_Vector%2032.svg" alt="" className="absolute bottom-[-33%] left-0 right-auto top-auto -z-10 hidden w-96 md:bottom-auto md:left-[136px] md:right-[-50%] md:top-[18%] md:inline-block lg:left-auto" />
      </div>
      ...
      <div className="relative flex flex-col items-center gap-4 p-8 text-center">
        ...
        <p className="mb-2 text-xl font-semibold">Earn</p>
        <p className="text-sm text-[#636262]">Lorem ipsum dolor sit amet consectetur adipiscing elit ut aliquam, purus sit.</p>
        <img src="https://assets.website-files.com/63904f663019b0d8edf8d57c/639834731925279c5e0b4ee5_Vector%2033.svg" alt="" className="absolute bottom-[-33%] left-0 right-auto top-auto -z-10 hidden w-96 md:bottom-auto md:left-[136px] md:right-[-50%] md:top-[8%] md:inline-block lg:left-auto" />
      </div>
      ...
      <div className="relative flex flex-col items-center gap-4 p-8 text-center">
        ...
        <p className="mb-2 text-xl font-semibold">Grow</p>
        <p className="text-sm text-[#636262]">Lorem ipsum dolor sit amet consectetur adipiscing elit ut aliquam, purus sit.</p>
      </div>
    </div>
  </div>
